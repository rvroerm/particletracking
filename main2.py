...
#
#my_beam = Beam(nb_part=1000, refE = 160, DeltaE=5, E_dist='cst',  \
...
#plt.hist(E_source[~np.isnan(E_source)], bins=20, alpha=0.3, label="E source")
#plt.hist(E_ISO[~np.isnan(E_ISO)], bins=20, alpha=0.3, label="E ISO")
