...
def run_from_transport(input_file = "C:/TRANS/for001.dat", nb_part=1000, \
    ...
    dEonE_1pc = refE/100
    nb_part_in_ESS = ((E_list_in < refE+dEonE_1pc) & (E_list_in > refE-dEonE_1pc)).sum()
    nb_part_in_ESS2 = ((E_list_in < refE+2*dEonE_1pc) & (E_list_in > refE-2*dEonE_1pc)).sum()
    ...
    nb_part_out_ESS = ((E_list_out_ESS < refE+dEonE_1pc) & (E_list_out_ESS > refE-dEonE_1pc)).sum()
    ...
    if output_results:
        ...
        print('ESS efficiency within E range [ %0.2f , %0.2f ] = %0.2f %%'%(refE-dEonE_1pc, refE+dEonE_1pc, nb_part_out_ESS/max(nb_part_in_ESS,1)*100))
        ...
        nb_part_out_GTR = ((E_list_out_GTR < refE+dEonE_1pc) & (E_list_out_GTR > refE-dEonE_1pc)).sum()
        
        print('GTR efficiency within E range [ %0.2f , %0.2f ] = %0.2f %%'%(refE-dEonE_1pc, refE+dEonE_1pc, nb_part_out_GTR/max(nb_part_out_ESS,1)*100))
        print('Total efficiency within E range [ %0.2f , %0.2f ] = %0.2f %%'%(refE-dEonE_1pc, refE+dEonE_1pc, nb_part_out_GTR/max(nb_part_in_ESS,1)*100))
        
        
        nb_part_out_GTR2 = ((E_list_out_GTR < refE+2*dEonE_1pc) & (E_list_out_GTR > refE-2*dEonE_1pc)).sum()
        
        print('Total efficiency within E range [ %0.2f , %0.2f ] = %0.2f %%'%(refE-2*dEonE_1pc, refE+2*dEonE_1pc, nb_part_out_GTR2/max(nb_part_in_ESS2,1)*100))
